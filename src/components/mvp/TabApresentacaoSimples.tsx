...
import { LogIn, Mail, Send, Play } from "lucide-react";
...
import { Sparkles, Music, Lock, Wrench, FlaskConical } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="section-description-academic">
              Demonstração das capacidades de análise estilística do VersoAustral
            </CardDescription>
          </div>
      ...
      <CardContent>
        ...
        <div className="space-y-6">
          ...
          <Alert className="bg-primary/5 border-primary/20">
            ...
            <AlertTitle>Análise Semântica Completa</AlertTitle>
            <AlertDescription className="space-y-2 mt-2">
              <p>Esta plataforma oferece análise semântica profunda revelando:</p>
              <p><strong>Domínios Semânticos:</strong> Distribuição temática comparativa entre corpus gaúcho e corpus de referência</p>
              <p><strong>Estatísticas Linguísticas:</strong> Métricas de keyness (Log-Likelihood e Mutual Information)</p>
              <p><strong>Visualizações Interativas:</strong> Nuvem de domínios e análises comparativas</p>
            </AlertDescription>
          </Alert>
