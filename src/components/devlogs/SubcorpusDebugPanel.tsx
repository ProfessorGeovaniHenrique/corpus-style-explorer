...
import { Database, Music, TrendingUp, HardDrive } from "lucide-react";
          ...
          <Tabs defaultValue="current" className="w-full">
            ...
            <TabsContent value="current" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                {!currentMetadata && selection.mode !== 'complete' && (
                  <Card>
                    ...
                    <div>
                      ...
                      {parseError ? (
                        <div className="p-4 bg-destructive/10 border border-destructive rounded-lg">
                          ...
                          <pre className="text-xs mt-2 text-destructive/80">{parseError}</pre>
                        </div>
                      ) : (
                        <pre className="p-4 bg-muted rounded-lg overflow-x-auto text-xs font-mono">
